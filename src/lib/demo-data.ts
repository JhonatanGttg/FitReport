  ...
  students: [
    {
      ...
      weeklyFrequency: 4,
      restrictions: "Sem restricoes relatadas.",
      clinicalNotes: "Acompanhar resposta de joelho em agachamentos profundos.",
    ...
    },
    {
      ...
      trainingLevel: "Intermediario",
      weeklyFrequency: 3,
      restrictions: "Historico de dor lombar leve.",
      clinicalNotes: "Priorizar estabilidade lombopelvica e progressao controlada.",
    ...
    },
    {
      ...
      weeklyFrequency: 5,
      restrictions: "",
      clinicalNotes: "Boa tolerancia a volume; monitorar fadiga.",
  ...
  reports: [
    {
      ...
      improved: ["reduziu gordura corporal", "melhorou cintura e abdomen"],
      worsened: [],
      needs: ["manter consistencia alimentar"],
      recommendations: ["Treino: manter progressao de cargas.", "Cardio: 3 sessoes semanais."],
      publicToken: "",
      publicEnabled: false,
